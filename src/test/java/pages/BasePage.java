...
public class BasePage {
    ...
    // return
    // getWait().until(ExpectedConditions.presenceOfElementLocated(By.xpath(locator)));
    // }
    ...
    public List<String> getDropdownValues(String locator) {
        Select dropdown = new Select(Find(locator)); // Encuentra el elemento del dropdown usando el locator
                                                     // proporcionado
